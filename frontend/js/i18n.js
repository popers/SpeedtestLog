export const translations = {
    'pl': {
        ...
        'latencyChartTitle': 'Opóźnienia pod obciążeniem (ms)',
        'chartLabelLatDlLow': 'Pobieranie (Niskie)',
        'chartLabelLatDlHigh': 'Pobieranie (Wysokie)',
        'chartLabelLatUlLow': 'Wysyłanie (Niskie)',
        'chartLabelLatUlHigh': 'Wysyłanie (Wysokie)',
        ...
        'detailsResultLinkText': 'Otwórz pełny wynik',
        'detailsClient': 'Klient IP: ',
        'detailsISP': 'Dostawca (ISP): ',
        'detailsLatencyLow': 'Min. opóźnienie (Niskie): ',
        'detailsLatencyHigh': 'Maks. opóźnienie (Wysokie): ',
        'detailsDownloadLatency': 'Opóźnienie pobierania (Niskie/Wysokie): ', 
        'detailsUploadLatency': 'Opóźnienie wysyłania (Niskie/Wysokie): ', 
        ...
        'chartColorLatDlLow': 'Pobieranie (Niskie)',
        ...
        'notifPushoverUser': 'Klucz Użytkownika (User Key):',
        'notifPushoverToken': 'Token API (API Token):',
    ...
    'en': {
        ...
        'pingChartTitle': 'Ping (ms)',
        'jitterChartTitle': 'Jitter (ms)',
        'latencyChartTitle': 'Loaded Latency (ms)',
        'chartLabelLatDlLow': 'Download (Low)',
        'chartLabelLatDlHigh': 'Download (High)',
        'chartLabelLatUlLow': 'Upload (Low)',
        'chartLabelLatUlHigh': 'Upload (High)',
        ...
        'detailsResultLinkText': 'Open full result',
        'detailsClient': 'Client IP: ',
        'detailsISP': 'ISP: ',
        'detailsLatencyLow': 'Min Latency (Low): ',
        'detailsLatencyHigh': 'Max Latency (High): ',
        'detailsDownloadLatency': 'Download Latency (Low/High): ', 
        'detailsUploadLatency': 'Upload Latency (Low/High): ', 
        ...
        'notifPushoverUser': 'User Key:',
        'notifPushoverToken': 'API Token:',
